...
document.writeln("<link href=\"resources/scripts/loading/css/swtMessageBox.css\" rel=\"stylesheet\" type=\"text/css\" />");
var tmplWaitting = '<div id="swt-messageBox-waiting">' +
    '<div class="bk">' +
    '</div>' +
    '<div class="cont">' +
    '<img src="resources/scripts/loading/css/loading.gif" alt="loading..." /><span class="swt-messageBox-waittingText" style="overflow:hidden; word-break:break-all;">正在加载...</span></div>' +
    '</div>';
