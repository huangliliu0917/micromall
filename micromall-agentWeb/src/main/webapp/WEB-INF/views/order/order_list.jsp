...
<div style="background-color:#545454;height:44px;">
    <p style="color:#fff; float:left;margin-top: 10px;margin-left: 10px;">我要进货</p>
            ...
            <c:forEach items="${pageInfo.getContent()}" var="orderBean">
                <li class="tttt">
                    <div class="DDH">单号：${orderBean.orderId}
                        ...
                        <c:if test="${orderBean.orderStatus==0}">
                    ...
                    <div class="DDDH"><span style="float:left; color:#999">2015-10-10 15:30</span><span style="float:right">金额：￥${orderBean.totalPrice}</span></div>
                </li>
            </c:forEach>
        </ul>
    </div>
