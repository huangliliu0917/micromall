...
<head>
    ...
    <script type="text/javascript">
        ...
        var ajaxUrl = "<c:url value="/orderApi/createOrderAgentOut" />";
...
<div class="dingdandiss_cell">
    <dl class="dingdandiss_dl dl_tabel">
        ...
        <dd><input style="border: solid 0px;color: #000;background-color: white;" type="text" id="shipAddr" placeholder="" value="${shipInfo.shipAddr}"></dd>
        <dt class="ui_color_weak ui_align_right">收件人：</dt>
        <dd><input style="border: solid 0px;color: #000;background-color: white;" type="text" id="shipName" placeholder="" value="${shipInfo.shipName}"></dd>
        <dt class="ui_color_weak ui_align_right">联系电话：</dt>
        <dd><input style="border: solid 0px;color: #000;background-color: white;" type="text" id="shipMobile" placeholder="" value="${shipInfo.shipMobile}"></dd>
    </dl>
</div>
