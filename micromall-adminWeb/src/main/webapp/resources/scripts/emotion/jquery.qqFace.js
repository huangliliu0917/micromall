    ...
    $.fn.qqFace = function (options) {
        ...
        $(this).click(function (e) {
            ...
            if ($('#' + id).length <= 0) {
                ...
                strFace += '</tr></table>';
                strFace += '<div class="emotionsGif" style="position:absolute;z-index:1000;top:-1px;left:473px;padding:20px;background-color:#FFF;text-align:center;width:24px;height:24px;"></div>';
                strFace += '</div>';
            }
